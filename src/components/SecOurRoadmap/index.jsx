...
const SecOurRoadmap = ({ data, img }) => {
  return (
    <section
      className="roadmap section-padding-100 bg-crypto"
      style={{
    ...
    >
      <SectionHeading
        ...
        text="Our tokenomics will fund the growth of our public charging network, join us on the road to 2030 (and beyond)"
      />
      <div id="evi-roadmap">
