          ...
          <div className="row justify-content-between">
            <div className="col-lg-12 pe-5">
              <div className="integration-details-wrap">
                <h2>EV Initiative Privacy Policy</h2>
                <p>
                  This privacy notice discloses the privacy practices for
                  www.evinitiative.com. This privacy notice applies solely to
                ...
                <div className="integration-feature-info mt-5">
                  ...
                  <h3 className="h5 mb-4 mt-5">Security</h3>
                  <p>
                  ...
                  <h3 className="h5 mb-4 mt-5">Cookies</h3>
                  <p>
                    ...
                    enhance the experience on our site. Usage of a cookie is in
                    no way linked to any personally identifiable information on
                    our site.
                  </p>
                </div>
              </div>
