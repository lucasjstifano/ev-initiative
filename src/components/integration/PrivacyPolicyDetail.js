            ...
            <div className="col-lg-12 pe-5">
              <div className="integration-details-wrap">
                <p>
                  ...
                  Statement of Privacy applies to https://www.evinitiative.com
                  and EV Initiative Inc. and governs data collection and usage.
                  For the purposes of this Privacy Policy, unless otherwise
                  noted, all references to EV Initiative Inc. include
                  https://www.evinitiative.com, EV Initiative, EV Initiative and
                  https://www.evinitiative.com. The EV Initiative website is a
                  Software service and application site. By using the EV
                  Initiative website, you consent to the data practices
                  described in this statement.
                </p>
                <div className="integration-feature-info mt-5">
                  <h3 className="h5 mb-4 mt-5">
                    Collection of your Personal Information
                  </h3>
                  <p>
                    In order to better provide you with products and services
                    offered on our Site, EV Initiative may collect personally
                  ...
                  <p>
                    EV Initiative collects and uses your personal information to
                    operate its website(s) and deliver the services you have
                    requested.
                  </p>
                  <p>
                    EV Initiative may also use your personally identifiable
                    information to inform you of other products or services
                    available from EV Initiative and its affiliates.
                  </p>
                  <h3 className="h5 mb-4 mt-5">
                    Sharing Information with Third Parties
                  </h3>
                  <p>
                    EV Initiative does not sell, rent or lease its customer
                    lists to third parties.
                  </p>
                  <p>
                    EV Initiative may share data with trusted partners to help
                    ...
                    information except to provide these services to EV
                    Initiative, and they are required to maintain the
                    confidentiality of your information.
                  </p>
                  <p>
                    EV Initiative may disclose your personal information,
                    ...
                    on EV Initiative or the site; (b) protect and defend the
                    rights or property of EV Initiative; and/or (c) act under
                    exigent circumstances to protect the personal safety of
                    users of EV Initiative, or the public.
                  </p>

                  <h3 className="h5 mb-4 mt-5">Tracking User Behavior</h3>
                  <p>
                    EV Initiative may keep track of the websites and pages our
                    users visit within EV Initiative, in order to determine what
                    EV Initiative services are the most popular. This data is
                    used to deliver customized content and advertising within EV
                    Initiative to customers whose behavior indicates that they
                    are interested in a particular subject area.
                  </p>
                  <p>Any and all methods utilized by google analytics</p>
                  ...
                  <p>
                    ...
                    automatically collected by EV Initiative. This information
                    ...
                    statistics regarding use of the EV Initiative website.
                  </p>
                  <h3 className="h5 mb-4 mt-5">
                    Security of your Personal Information
                  </h3>
                  <p>
                    EV Initiative secures your personal information from
                    unauthorized access, use, or disclosure. EV Initiative uses
                    the following methods for this purpose: -SSL Protocol
                  </p>
                  <p>
                  ...
                  <h3 className="h5 mb-4 mt-5">Right to Deletion</h3>
                  <p>
                  ...
                  <h3 className="h5 mb-4 mt-5">Children Under Thirteen</h3>
                  <p>
                    EV Initiative does not knowingly collect personally
                  ...
                  <h3 className="h5 mb-4 mt-5">E-mail Communications</h3>
                  <p>
                    From time to time, EV Initiative may contact you via email
                    ...
                    receive a notification when you open an email from EV
                    Initiative or click on a link therein.
                  </p>
                  <p>
                    If you would like to stop receiving marketing or promotional
                    communications via email from EV Initiative, you may opt out
                    of such communications by emailing legal@EV Initiative.com
                    or clicking on the UNSUBSCRIBE button in emails.
                  </p>
                  <h3 className="h5 mb-4 mt-5">External Data Storage Sites</h3>
                  <p>
                    We may store your data on servers provided by third party
                    hosting vendors with whom we have contracted.
                  </p>
                  <h3 className="h5 mb-4 mt-5">Changes to this Statement</h3>
                  <p>
                    EV Initiative reserves the right to change this Privacy
                  ...
                  <h3 className="h5 mb-4 mt-5">Contact Information</h3>
                  <p>
                    EV Initiative welcomes your questions or comments regarding
                    this Statement of Privacy. If you believe that EV Initiative
                    has not adhered to this Statement, please contact EV
                    Initiative at:
                  </p>
                  <p>Email Address: info@evinitiative.com</p>
                  <p>Effective as of November 1, 2021</p>
                </div>
              </div>
            </div>
          </div>
